...
- **[Pricing](/pricing/)** — Free Starter (3 domains / 50 mailboxes) + Pro at $29/tenant/month with the full API, multi-tenancy, and analytics.
...
If you'd rather read more before deciding: see [Email deliverability best practices](/guides/deliverability) for the deep technical detail, the [IP warmup guide](/guides/ip-warmup) for what month-one looks like, and the [alternatives](/alternatives/) pages for an honest comparison against the other self-host stacks. If you're ready to try the platform itself: [Getting started](/getting-started/) walks through a working install on a fresh VPS.
